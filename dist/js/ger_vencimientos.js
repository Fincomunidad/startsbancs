...
var Mensaje = function (_React$Component3) {
    ...
    function Mensaje(props) {
        ...
        _this4.state = {
            ...
            titulo: "Aplica a cuenta",
            pregunta: "¿Desea autorizar la cancelación del registro?"
        };
        return _this4;
    }
...
var RecordDetalle = function (_React$Component4) {
    ...
    function RecordDetalle(props) {
        ...
        var _this5 = _possibleConstructorReturn(this, (RecordDetalle.__proto__ || Object.getPrototypeOf(RecordDetalle)).call(this, props));

        _this5.handleDeleteRecord = _this5.handleDeleteRecord.bind(_this5);
    ...
    _createClass(RecordDetalle, [{
        ...
        value: function render() {
            ...
            var cancela = null;
            if (this.props.registro.cancela == '1' && this.props.registro.estatus != 'Aplicado') {
                cancela = React.createElement(
                    "a",
                    { "data-tooltip": "Cancelar registro" },
                    React.createElement("i", { className: "trash inline icon circular red", onClick: this.handleDeleteRecord })
                );
            }
...
var RecordCredito = function (_React$Component5) {
    ...
    _createClass(RecordCredito, [{
        ...
        value: function render() {
            var autoriza = this.props.registro.autoriza == 'f' || this.props.registro.autoriza == false ? 'En espera' : 'Autorizado';
            var style = { color: 'red' };
            var dias = React.createElement(
                "td",
                null,
                this.props.registro.dias
            );
            var importe = React.createElement(
                "td",
                null,
                this.props.registro.importe
            );
            if (esquema != 'fin.' && esquema != 'ama.') {
                dias = null;
            }
            if (esquema != 'ama.') {
                importe = null;
    ...
    _createClass(Table, [{
        ...
        value: function render() {
            ...
            if (this.props.name == "inversion") {
                ...
                if (esquema == 'fin.') {
                    enca = ['Id', 'Acreditada', 'Pagaré', 'Nombre', 'Monto', 'Primer Pago', 'Fec. Aprobación', 'Fec. Dispersa', 'Fec. Entrega', 'Fec. Vence', 'Dias', 'Estatus'];
                } else if (esquema == 'ama.') {
                    enca = ['Id', 'Acreditada', 'Pagaré', 'Nombre', 'Monto', 'Primer Pago', 'Fec. Aprobación', 'Fec. Dispersa', 'Fec. Entrega', 'Fec. Vence', 'Dias', 'Importe', 'Estatus'];
                } else {
...
var Captura = function (_React$Component7) {
    ...
    _createClass(Captura, [{
        ...
        value: function handleClickRecord(e, rec) {
            var datar = rec;
            datar = Object.assign({ 'data': 'data' }, datar);
            //	console.log(datar);
            datar['retiroccheck'] = 'on';
            datar['retiroicheck'] = 'on';
            datar['incrementocheck'] = 'off';
            datar['incremento'] = 0;
            datar['retiroc'] = 0;
            datar['retiroi'] = datar.interes;
            datar['cretiroc'] = 'V';
            datar['cretiroi'] = 'V';
            datar['importei'] = datar.importe;
            datar['interesi'] = datar.interes;
            datar['totali'] = datar.total;
            datar['numeroi'] = datar.numero;
            datar['idacreditado'] = datar.idacreditado;

            //	console.log(datar);

            var idacredita = datar.idacreditado;
            var forma = this;
            var token = $('#csrf').val();
            //	let token = $('#csrf_bancomunidad_token').val();
            ...
            $('.mini.modal').modal({
                ...
                onApprove: function onApprove() {
                    ...
                    ajax(object).then(function resolve(response) {
                        ...
                        //					let newArray = [...forma.state.catINE, recUpdate];
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "form",
                        { className: "ui form formreinv", ref: "form" },
                        React.createElement(
                            "div",
                            ...
                            React.createElement(
                                "div",
                                null,
                                React.createElement(Table, { name: "inversion", datos: this.state.catInversion, onClick: this.handleClickRecord.bind(this) })
                            )
                        )
                    )
                )
