...
var Captura = function (_React$Component6) {
    ...
    function Captura(props) {
        ...
        _this9.state = { activo: 0,
            ...
            idcolmena: 0, catColmenas: [], idgrupo: 0, catGrupos: [], catOrden: []
        };
        return _this9;
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    this.setState({ catColmenas: response.catcolmenas,
                        catOrden: response.cat_grupo_orden,
            ...
            if (valida == true) {
                ...
                $('.mini.modal').modal({
                    ...
                    onApprove: function onApprove() {
                        var object = {
                            url: base_url + 'api/CarteraD1/set_acreditado_change_grupo',
                            type: tipo,
                            dataType: 'json',
                            data: {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(InputFieldFind, { cols: "two wide", icons: this.state.icons1, readOnly: this.state.activo == 1 || this.state.activo == 2 ? 'readOnly' : '', id: "idacreditado", name: "idacreditado", valor: this.state.idacreditado, label: "No. acreditado", placeholder: "Buscar", onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) }),
                            React.createElement(InputField, { id: "acreditado_nombre", readOnly: 'readOnly', label: "Nombre", name: "acreditado_nombre", valor: this.state.acreditado_nombre, onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) })
                        ),
                        React.createElement(
                            "div",
                            { className: "three fields" },
                            React.createElement(InputField, { id: "colmena_nombre", readOnly: 'readOnly', label: "Colmena", name: "colmena_nombre", valor: this.state.colmena_nombre, cols: "five wide", onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) }),
                            React.createElement(InputField, { id: "cargo_colmena", readOnly: 'readOnly', label: "Cargo Colmena", name: "cargo_colmena", valor: this.state.cargo_colmena, cols: "five wide", onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) }),
                            React.createElement(InputField, { id: "colmena_grupo", readOnly: 'readOnly', label: "Grupo", name: "colmena_grupo", valor: this.state.colmena_grupo, cols: "five wide", onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) }),
                            React.createElement(InputField, { id: "cargo_grupo", readOnly: 'readOnly', label: "Cargo Grupo", name: "cargo_grupo", valor: this.state.cargo_grupo, cols: "five wide", onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) }),
                            React.createElement(InputField, (_React$createElement = { cols: "two wide", id: "colmena_grupo_orden", readOnly: 'readOnly', label: "Orden", name: "colmena_grupo_orden", valor: this.state.colmena_grupo_orden }, _defineProperty(_React$createElement, "cols", "five wide"), _defineProperty(_React$createElement, "onChange", this.handleInputChange.bind(this)), _defineProperty(_React$createElement, "onClick", this.handleFind.bind(this)), _React$createElement))
                        ),
                        React.createElement(
                            "div",
                            { className: "three fields" },
                            React.createElement(SelectDropDown, { name: "idcolmena", id: "idcolmena", label: "Nueva Colmena", valor: this.state.idcolmena, valores: this.state.catColmenas, onChange: this.handleInputChange.bind(this) }),
                            React.createElement(SelectDropDown, { name: "idgrupo", id: "idgrupo", label: "Nuevo Grupo", valor: this.state.idgrupo, valores: this.state.catGrupos, onChange: this.handleInputChange.bind(this) }),
                            React.createElement(SelectDropDown, { name: "grupo_orden", id: "grupo_orden", label: "Nueva Posici\xF3n", valor: this.state.grupo_orden, valores: this.state.catOrden, onChange: this.handleInputChange.bind(this) })
                        ),
                        React.createElement(
                            "div",
                            { className: "three fields" },
                            React.createElement(SelectDropDown, { name: "idcol_cargo", id: "idcol_cargo", label: "Nuevo Cargo colmena", valor: this.state.idcol_cargo, valores: this.state.cat_col_cargos, onChange: this.handleInputChange.bind(this) }),
                            React.createElement(SelectDropDown, { name: "idgrupo_cargo", id: "idgrupo_cargo", label: "Nuevo Cargo grupo", valor: this.state.idgrupo_cargo, valores: this.state.cat_grupo_cargos, onChange: this.handleInputChange.bind(this) })
                        ),
                        React.createElement(
                            "div",
                            { className: "field" },
