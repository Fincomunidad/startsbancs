            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "thead",
                        null,
                        React.createElement(Lista, { enca: ['No', 'Acreditada', 'Sucursal', 'Credito', 'Capital vigente', 'Pago total', 'Pago capital', 'Int. pag', 'IVA pag', 'Saldo capital', 'Interes diario', 'IVA diario'] })
                    ),
                    React.createElement(
                        "tbody",
                        null,
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "thead",
                        null,
                        React.createElement(Lista, { enca: ['No', 'Acreditada', 'Sucursal', 'Cuenta', 'Imp. base', 'Interes', 'Poliza'] })
                    ),
                    React.createElement(
                        "tbody",
                        null,
    ...
    _createClass(Captura, [{
        ...
        value: function handleButton(e, value) {
            if (e === 2) {
                var forma = this;
                $.ajax({
                    url: base_url + '/api/CarteraD1/get_provision_ahorro/' + this.state.idfecha,
                    type: 'GET',
                    dataType: 'json',
                    success: function (response) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(SelectDropDown, { id: "idfecha", label: "Fecha de calculo", valor: this.state.idfecha, valores: this.state.catfechas, onChange: this.handleInputChange.bind(this) }),
                        React.createElement(
                            "div",
