        ...
        value: function handleFind(event, value, name) {
            ...
            ajax(object).then(function resolve(response) {
                ...
                if (response.socio[0] != undefined) {
                    ...
                    if (response.socio[0].fecalta != null) {
                        fecha = moment(response.socio[0].fecalta).format('DD/MM/YYYY');
                    }
                    var idcolcargo = 0;
                    var idgrupocargo = 0;
                    ...
                    var fecha = moment(new Date(), 'DD/MM/YYYY').format('DD/MM/YYYY');
                    forma.setState(_defineProperty({
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(InputField, { id: "fechaalta", readOnly: 'readOnly', label: "Fecha alta", name: "fechaalta", valor: this.state.fechaalta, onChange: this.handleInputChange.bind(this), onClick: this.handleFind.bind(this) })
                            ),
