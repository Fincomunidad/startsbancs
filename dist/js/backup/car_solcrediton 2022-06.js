            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "thead",
                        null,
                        React.createElement(Lista, { enca: ['Semana', 'Vencimiento', 'Capital', 'Interes', 'IVA', 'Total'] })
                    ),
                    React.createElement(
                        "tbody",
                        null,
...
var Captura = function (_React$Component11) {
    ...
    function Captura(props) {
        ...
        _this15.state = {
            ...
            fecha_pago: "", fecha_pago2: "", fecha_entrega_col: "",
            ...
            periodo: 'S', cat_periodo: [],
            num_pagos: '6', cat_num_pagos: [],
            cat_tasa: [], tasa: 2,
    ...
    _createClass(Captura, [{
        ...
        value: function componentWillMount() {
            ...
            $.ajax({
                url: base_url + '/api/GeneralD1/get_solicitud_cred_ind',
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    this.setState({
                        ...
                        cat_periodo: response.cat_periodo,
                        cat_num_pagos: response.cat_num_pagos,
                        cat_tasa: response.cat_tasa,
                        cat_iva: response.cat_iva
                    });
                }.bind(this),
        ...
        value: function asignaAcreditado(data) {
            ...
            let col_nombre = "";
            let col_grupo = "";
            if (data.colmena_grupo==null){
                alert("Null");
                col_nombre=data.col_nombre;
                col_grupo = data.colmena_grupo;
            }
            */
            ...
            this.setState((_setState2 = {
                ...
                colmena_nombre: data.col_nombre == null ? "" : data.col_nombre,
                colmena_grupo: data.grupo_nombre == null ? "" : data.grupo_nombre,

                actividad_nombre: "",
                edocivil_nombre: ""

            }, _defineProperty(_setState2, "actividad_nombre", data.actividad_nombre), _defineProperty(_setState2, "edocivil_nombre", data.edocivil_nombre), _defineProperty(_setState2, "domicilio", data.direccion == null ? "" : data.direccion), _defineProperty(_setState2, "idgrupo", data.idgrupo), _setState2));
        ...
        value: function handleButton(e, value) {
            ...
            if (e < 2) {
                ...
                if (this.state.boton == "Actualizar") {
                    ...
                    var link = "";
                    if (e === 10) {
                        link = "pdf_solicitud_credito_ind";
                    } else if (e === 11) {
                        link = "pdf_pagare";
                    } else if (e === 12) {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "button",
                                { className: "ui button", "data-tooltip": "Saldos" },
                                React.createElement("i", { className: "file pdf outline icon", onClick: this.handleButton.bind(this, 21) })
                            )
                        ),
                        React.createElement(
                            "div",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(SelectDropDown, { id: "periodo", label: "Periodo",
                                    valor: this.state.periodo, valores: this.state.cat_periodo,
                                    onChange: this.handleInputChange.bind(this) }),
                                React.createElement(SelectDropDown, { id: "num_pagos", label: "Num. pagos",
                                    valor: this.state.num_pagos, valores: this.state.cat_num_pagos,
                                    onChange: this.handleInputChange.bind(this) }),
                                React.createElement(SelectDropDown, { id: "iva", label: "Desglosa IVA",
                                    valor: this.state.iva, valores: this.state.cat_iva,
                                    onChange: this.handleInputChange.bind(this) })
                            ),
                            React.createElement(
                                "div",
                                { className: "four fields" },
                                React.createElement(SelectDropDown, { id: "tasa", label: "Tasa mensual", valor: this.state.tasa, valores: this.state.cat_tasa, onChange: this.handleInputChange.bind(this) }),
                                React.createElement(
                                    "div",
                                    { className: "field" },
                                ...
                                React.createElement(
                                    "div",
                                    { className: this.state.periodo === "Q" ? "field" : "disablediv" },
                                    React.createElement(Calendar, { name: "fecha_pago2", label: "Fecha segundo pago", valor: this.state.fecha_pago2, onChange: this.handleInputChange.bind(this) })
                                )
                            ),
                            React.createElement(
                                "div",
