                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(InputField, { id: "promotor", label: "Promotor", valor: this.state.col_promotor, onChange: this.handleInputChange.bind(this) }),
                            React.createElement(InputField, { id: "dia", label: "Dia", valor: this.state.dia, cols: "five wide", onChange: this.handleInputChange.bind(this) }),
                            React.createElement(InputField, { id: "hora", label: "Hora", valor: this.state.hora, cols: "five wide", onChange: this.handleInputChange.bind(this) })
                        ),
                        React.createElement(
                            "div",
                            { className: "segment" },
