        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("input", { className: may, id: this.props.id, name: this.props.id, type: "text", value: this.props.valor, placeholder: this.props.placeholder, onChange: function onChange(event) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("input", { id: this.props.id, name: this.props.id, type: "text", placeholder: this.props.placeholder, onChange: function onChange(event) {
                            return _this6.setState({ value: event.target.value });
                        }, onKeyPress: function onKeyPress(event) {
                            return _this6.props.onKeyPress(event, _this6.state.value);
                        } }),
                    React.createElement("i", { className: this.props.icons, onClick: function onClick(event) {
                            return _this6.props.onClick(event, _this6.state.value);
                        } })
                )
            );
        }
...
var SelectOptionMultiple = function (_React$Component8) {
    _inherits(SelectOptionMultiple, _React$Component8);

    function SelectOptionMultiple(props) {
        _classCallCheck(this, SelectOptionMultiple);

        var _this12 = _possibleConstructorReturn(this, (SelectOptionMultiple.__proto__ || Object.getPrototypeOf(SelectOptionMultiple)).call(this, props));
...
var SelectOption = function (_React$Component9) {
    ...
    function SelectOption(props) {
        ...
        var _this13 = _possibleConstructorReturn(this, (SelectOption.__proto__ || Object.getPrototypeOf(SelectOption)).call(this, props));
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            { className: checked, onClick: function onClick(event) {
                                    return _this15.props.onClickCheck(event, _this15.props.name, _this15.props.valor);
                                } },
...
var Captura = function (_React$Component11) {
    ...
    function Captura(props) {
        ...
        var _this16 = _possibleConstructorReturn(this, (Captura.__proto__ || Object.getPrototypeOf(Captura)).call(this, props));

        _this16.state = { activo: 0,
            ...
            rfc: "", curp: "", folio_ife: "", vine: 0, otroiden: "", email: "", conyuge: "", celular: "", direccion1: "",
    ...
    _createClass(Captura, [{
        ...
        value: function componentWillMount() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    this.setState({ catestado: response.estado, catpais: response.pais, catEstadoB: catEstadoB, idestado: '20', catmpio: response.mpio,
        ...
        value: function handleInputChange(event) {
            ...
            //name === "idestado" ||
            if (name === "idmunicipio" || name === "idcolonia" || name == "personarel" && value == "1") {
                var link = "";
                if (name === "idestado") {
                    link = "catmpio";
                ...
                fields: {
                    ...
                    direccion2: {
                        ...
                        rules: [{
                            ...
                            type: 'maxLength[70]',
                            prompt: 'Longitud máxima de 70 caracteres '
                        }]
                    },
                    noexterior: {
                ...
                fields: {
                    ...
                    domlabref: {
                        ...
                        rules: [{
                            ...
                            type: 'maxLength[40]',
                            prompt: 'Longitu máxima de 40 caracteres'
                        }]
                    },
                    ingresomen: {
        ...
        value: function asignaPersona(data) {
            ...
            this.setState({ fechaalta: fecalta, fechaaltad: fecalta, fechaaltab: fecalta, tipo: data.tipo, cia: data.cia, idtiposociedad: data.idtiposociedad, nombre1: data.nombre1, nombre2: data.nombre2,
                ...
                personalrel: data.personarel, idpersonarel: data.idpersonarel
            });
            var $form = $('.get.soling form'),
        ...
        value: function incialPersona() {
            this.setState({ tipo: 'F', cia: '', idtiposociedad: '', nombre1: '', nombre2: '',
                ...
                egresomen: '', egresomenext: '', dependientes: '', ahorro: ''
            });
            var $form = $('.get.soling form'),
        ...
        value: function asignaBen(data) {
            if (data != undefined) {
                ...
                var $form = $('.get.solingben form'),
                    Folio = $form.form('set values', { idparentesco: data.idparentesco, sexo_ben: data.sexo });
            } else {
                this.inicialBen();
            }
        }
        ...
        value: function inicialBen() {
            ...
            var $form = $('.get.solingben form'),
                Folio = $form.form('set values', { idparentesco: '' });
        }
    }, {
        key: "autoReset",
        ...
        value: function findData(value) {
            ...
            ajax(object).then(function resolve(response) {
                ...
                if (response.ben[0] != undefined) {
                    forma.setState({
                        boton3: 'Actualizar', disabledboton3: ''
                    });
                } else {
                    forma.setState({
                ...
                forma.inicialDom();
                forma.inicialBen();
                forma.setState({ boton: 'Enviar', boton2: 'Enviar', disabledboton2: 'disabled', boton3: 'Enviar', disabledboton3: 'disabled' });
                forma.autoReset();
            });
        }
    }, {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("i", { className: "close icon", onClick: function onClick(event) {
                            window.clearTimeout(_this17.timeout);
                            _this17.setState({ message: '', statusmessage: 'ui message hidden' });
                        } })
                ),
                React.createElement(
                    "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(Calendar, { name: "fechaalta", label: "Fecha alta", valor: this.state.fechaalta, onChange: this.handleInputChange.bind(this) })
                                )
                            )
                        ),
                        React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "two fields" },
                                React.createElement(InputField, { id: "aliaspf_ben", mayuscula: "true", label: "Conocida(o) como", valor: this.state.aliaspf_ben, onChange: this.handleInputChange.bind(this), disabled: this.state.disabledboton3 }),
                                React.createElement(
                                    "div",
                                    { className: "two fields" },
                                    ...
                                    React.createElement(InputField, { id: "rfc_ben", mayuscula: "true", label: "RFC", valor: this.state.rfc_ben, onChange: this.handleInputChange.bind(this), disabled: this.state.disabledboton3 })
                                )
                            ),
                            React.createElement(
                                "div",
                                { className: "four fields" },
                                React.createElement(InputField, { id: "telefono_ben", cols: "s3", label: "Celular", valor: this.state.telefono_ben, onChange: this.handleInputChange.bind(this), disabled: this.state.disabledboton3 }),
                                React.createElement(SelectDropDown, { id: "idparentesco", label: "Parentesco", valor: this.state.parentesco, valores: this.state.catparentesco, onChange: this.handleInputChange.bind(this), disabled: this.state.disabledboton3 }),
                                React.createElement(
                                    "div",
                                    { className: "two fields" },
                                    React.createElement(InputField, { id: "porcentaje", cols: "s3", label: "% participaci\xF3n", valor: this.state.porcentaje, onChange: this.handleInputChange.bind(this), disabled: this.state.disabledboton3 })
                                )
                            ),
                            React.createElement(
                                "div",
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "button",
                                        { className: "ui bottom primary basic button", type: "button", name: "action", disabled: this.state.disabledboton3, onClick: this.handleSubmitBen.bind(this) },
                                        React.createElement("i", { className: "send icon" }),
                                        " ",
                                        this.state.boton3,
                                        " "
