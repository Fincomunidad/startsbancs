            ...
            if (valida == true) {
                ...
                $('.mini.modal').modal({
                    ...
                    onApprove: function onApprove() {
                        ...
                        var object = {
                            url: base_url + 'api/CarteraD1/add_credito/' + 1,
                            type: tipo,
                            dataType: 'json',
                            data: {
                        ...
                        ajax(object).then(function resolve(response) {
                            if (forma.state.boton === 'Enviar') {
                                ...
                                console.log('ENTRO AGREGADO ELSE');
                                forma.setState({
                                    csrf: response.newtoken,
                                    message: response.message,
                                    statusmessage: 'ui positive floating message ',
                            ...
                            if (reason.statusText === 'OK') {
                                console.log(reason);
                                console.log('ENTRO AGREGADO 1');
                                //$pos =  strripos(reason.responseText, '')
                                var dato = reason.responseText;
                                console.log(dato);
                                var _idcredito2 = dato.insert_id;
                                forma.setState({
                                    idcredito: _idcredito2,
                                    idexiste: _idcredito2,
                                    csrf: response.newtoken,
                                    message: response.message + ' ' + response.insert_id,
                                    statusmessage: 'ui positive floating message ',
                                    boton: 'Enviar'
                                });
                            } else {
                                console.log('ENTRO REJECT 1');
                                console.log(reason);
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(InputField, { id: "sancion", label: "sancion", readOnly: "readOnly", valor: this.state.sancion, onChange: this.handleInputChange.bind(this) })
                                )
                            ),
                            React.createElement(
                                "div",
