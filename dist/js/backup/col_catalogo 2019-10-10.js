                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            this.setState({
                                ...
                                col_promotor: response.colmena_info.promotor,
                                dia: response.colmena_info.dia_text,
                                hora: response.colmena_info.horainicio,
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "button",
                            { className: "ui button", "data-tooltip": "Creditos vigentes por colmena" },
                            React.createElement("i", { className: "file pdf outline icon", onClick: this.handleButton.bind(this, 5) })
                        ),
                        React.createElement(
                            "button",
                            { className: "ui button", "data-tooltip": "Creditos vigentes por empresa" },
                            React.createElement("i", { className: "file pdf outline icon", onClick: this.handleButton.bind(this, 6) })
                        ),
                        React.createElement(
                            "button",
                            { className: "ui button", "data-tooltip": "Creditos vigentes globales" },
                            React.createElement("i", { className: "file pdf outline icon", onClick: this.handleButton.bind(this, 7) })
                        )
                    )
                ),
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(InputField, { id: "promotor", readOnly: "readOnly", label: "Promotor", valor: this.state.col_promotor, cols: "ten wide", onChange: this.handleInputChange.bind(this) }),
                            React.createElement(InputField, { id: "dia", readOnly: "readOnly", label: "Dia de reunion", valor: this.state.dia, cols: "three wide", onChange: this.handleInputChange.bind(this) }),
                            React.createElement(InputField, { id: "hora", readOnly: "readOnly", label: "Hora", valor: this.state.hora, cols: "three wide", onChange: this.handleInputChange.bind(this) })
                        ),
                        React.createElement(
                            "div",
                            { className: "segment" },
