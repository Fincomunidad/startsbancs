...
<body style>
    ...
    <?php if($this->ion_auth->logged_in()):?>
        <div class="ui top attached demo menu">
            <div class="ui inverted borderless fixed  menu <?php  echo (strtoupper($this->session->userdata('esquema')) =='FIN.'?'navy': (strtoupper($this->session->userdata('esquema')) =='BAN.'?'teal':'yellow')) ;?>"  >
            ...
            <!-- Menu de usuario activo, sistemas y cerrar sesión-->   
                    <div class="ui simple dropdown right item">
                        ...
                        <div class="menu">
                            ...
                            <?php endif;?>
                            <a class="item" href="#!"><i class="settings icon"></i>Perfil</a>
