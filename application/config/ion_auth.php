...
*/
$config['tables']['users']           = 'security.users';
$config['tables']['groups']          = 'security.groups';
$config['tables']['users_groups']    = 'security.users_groups';
$config['tables']['login_attempts']  = 'security.login_attempts';

$config['tables']['options']  = 'security.options';
$config['tables']['profile']  = 'security.profile';
$config['tables']['profile_options']  = 'security.profile_options';
$config['tables']['users_profiles']  = 'security.users_profiles';
...
$config['change_password'] 			  = 90;                   // The number of days to change password
 ...
 */
$config['remember_cookie_name'] = 'bancomunidad_code';
