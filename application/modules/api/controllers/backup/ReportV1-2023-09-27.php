...
//		$canvas->page_text(500, 770, "Página: {PAGE_NUM} de {PAGE_COUNT}", $font, 7, array(0,0,0));
	...
	public function aportacertif2_get()
	{
		...
		$header = generateReportHeader('Certificado de Aportación Social', $empresaLargo, 'CERTIFICADO DE APORTACIÓN A CAPITAL SOCIAL', $this->getLogo(120), '14px');
		//$header .= $this->getLogo(120);
		$html = $header;
	...
	public function repaportasoc_get(){
		...
		/*$html='
			<html>
				<head>
					<meta charset="UTF-8" />
					<title>Reporte de Aportación Social</title>
				</head>
			<body>
		';*/
		...
		//$header.= '<p>'.$titulo.' DE APORTACIÓN SOCIAL  DEL '.$fecini1.' AL '.$fecfin2.' </p>';
		// 25 - 09 -2023
		$tit = '<p>' . $titulo . ' DE APORTACIÓN SOCIAL  DEL ' . $fecini1 . ' AL ' . $fecfin2 . ' </p>';
		$header = generateReportHeader('Reporte de Aportación Social', $empresa, $tit);
		...
		public function repseguros_get(){
			...
			$header='<font size="15px">';
			$header.= '<p align="center" >'.$empresal.'</p><br>';
			$header.= $this->getLogo(60);
			$header.= '<p>'.$titulo.' DEL '.$fecini1.' AL '.$fecfin2.' </p>';
