...
class GeneralD1 extends BaseV1 {
	...
	*/
	...
	public function get_solicitud_credito_get() {
		...
		//$actividad = $this->base->selectRecord("actividades","idactividad as value, nombre as name", "", "", "", "", "","", "", "",TRUE);
	...
	public function get_colmenas_asigna_get() {
		...
		//selectRecord("public.cat_cargo", $fields, 	"", 			"", 			"",			"", 		"",  				$order_by, 				"",				"", 			TRUE);		
		//selectRecord($tabla, 			$select, 	$join=array(), $where=array(), $limit=null, $offset=null, $group_by=array(), $order_by = array(), $like =array(), $whereor=array(), $returnData=FALSE, $where_in =array()){
