...
//and (c.fecha_aprov is null or c.fecha_dispersa is null or c.fecha_entrega is null) 
	...
	* Aportación Social
	...
	public function colmenas_get(){
		...
		$tabla = "col.get_colmena_grupo as a";
		...
		$group_by = array("a.idcolmena","colmena_numero::text || ' ' || a.colmena_nombre", "colmena_numero");
		$order_by = array(array('campo'=> 'a.colmena_numero',
				'direccion'=>	'asc'));
...
*/
	...
	*/
	...
	public function getInstrumento_get(){
		...
		$instrumento = $this->base->querySelect($query, TRUE);
		if ($instrumento) {
						
			$data = array("status"=>"OK",
				"code" => 200,
				"message"=>'Registro obtenido correctamente!',
				"catinstrumento" => $instrumento,
				);
		} else {
			$data = array("status"=>"ERROR",
				"code" => 404,
