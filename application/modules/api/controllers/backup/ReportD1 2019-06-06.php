...
*/
	...
	public function pdf_colmenas_dir_get(){
		...
		$title = array("Núm.", "Colmena", "Dia", "Promotor", "Hora", "Fecha apertura", "Fecha cierre", "Empresa", "Municipio", "Colonia", "Direccion", "Referencia");
		if ($tipo==="3"){
			$where = " where idsucursal='".$this->session->userdata('sucursal_id')."' and fechacierre is null ";
			$title = array("Núm.", "Colmena", "Dia", "Promotor", "Hora", "Fecha apertura", "Empresa", "Municipio", "Colonia", "Direccion", "Referencia");
		...
		$query = "SELECT numero, nombre, dia_text, promotor, horainicio, fecha_apertura::date, fechacierre::date, empresa, d_mnpio, d_asenta, direccion, direccion_ref from col.v_colmenas_directorio ".$where." ORDER BY numero";
		$amor = $this->base->querySelect($query, TRUE);
