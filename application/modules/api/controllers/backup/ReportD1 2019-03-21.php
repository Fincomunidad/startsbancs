...
*/
	...
	public function pdf_tabla_amortizacion_get(){
		...
		$dias = 175;
		$fields = array("dias");
		$where = array("nivel" => $cred['nivel']);
		$order_by = array(array('campo'=> 'fecha_inicio', 'direccion'=>	'DESC'));
		$niv = $this->base->selectRecord("niveles", $fields, "", $where, "","", "", $order_by, "","", TRUE);
		$niv = $niv[0];
		if ($niv){
			$dias = $niv['dias'];	
		}		
        ...
        $html.='<br>
			<table style="width:100%" border="0" class="100p">
				...
				<tr>
					...
					<th class="seccion-left">
						Mora: '.number_format($tasa_mora, 2, '.', ',').'%
					</th>		
				</tr>									
				<tr>
					<th class="seccion-left">
...
*/
	...
	public function pdf_emision_cheques_year_get(){
		...
		$query = "SELECT fecha, acreditado_nombre, nivel, monto, total_garantia, cheque_ref, idgrupo, colmena_numero, colmena_grupo, promotor, proy_observa 
	...
	public function html_datos_acre_get(){
		...
		$fields = array("idacreditado", "id_isis", "idsucursal", "nombre", "persona", "estado_civil", "fecha_nac", "edad", "sexo", "cp", "localidad", "municipio", "aportacion_social", "actividad", "dependientes", "tipovivienda", "aguapot", "enerelec", "drenaje","colmena", "grupo");
		...
		$title = array("No","Isis","Suc","Nombre","Persona","Edo.Civil","Fec.Nac.","Edad", "Sexo", "CP", "Localidad", "Municipio", "Ap.Soc.", "Actividad", "Dep.", "Vivienda", "Agua", "Elec.", "Drenaje","Colmena","Grupo");
