...
/*
	...
	public function niveles_query_get(){
		...
		*/
            $query ="SELECT n.idnivel, n.nivel, to_char(n.importe,'999,999') as importe, n.numero_pagos, n.fecha_inicio FROM niveles as n WHERE upper(n.nivel::varchar) like '".$nombre."%' ORDER BY n.nivel limit 8";
