...
//        if (($this->input->is_ajax_request() === FALSE OR $this->input->is_ajax_request() ==="") && $this->config->item('rest_ajax_only'))
...
//            $this->response(["status"=>FALSE,"error"=>"Only AJAX requests are accepted."], self::HTTP_NOT_ACCEPTABLE);
                redirect(404);
        }
